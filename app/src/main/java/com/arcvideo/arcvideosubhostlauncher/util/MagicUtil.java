...
public class MagicUtil {
    ...
    public static int getFileType(String filepath){
        ...
        String magicnuber = getMagicNumber(filepath);
        ...
        while (iterator.hasNext()){
            ...
            if (key.startsWith(magicnuber.toLowerCase())){
    ...
    private static void mapFileType(){
        ...
        fileTypeMap.put("00000020667479706d70", new MagicInfo("mp4", MagicInfo.VIDEO_TYPE)); // mp4
